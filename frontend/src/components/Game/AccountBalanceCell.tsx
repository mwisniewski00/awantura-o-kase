...
const AccountBalanceCellContainer = styled.div<{
...
export function AccountBalanceCell({ playerId, playerColor }: BiddingCellProps) {
  const {
  ...
  return (
    <AccountBalanceCellContainer
      backgroundColor={PLAYER_CSS_COLORS[playerColor]}
      isCurrentPlayer={isCurrentPlayer}>
      {accountBalances[playerId]}
    </AccountBalanceCellContainer>
  );
}
